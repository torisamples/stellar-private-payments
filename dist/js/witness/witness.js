...
export class WitnessCalculator {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WitnessCalculatorFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_witnesscalculator_free(ptr, 0);
    }
    /**
    ...
    compute_witness(inputs_json) {
        try {
            ...
            wasm.witnesscalculator_compute_witness(retptr, this.__wbg_ptr, ptr0, len0);
     ...
     */
    constructor(circuit_wasm, r1cs_bytes) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(circuit_wasm, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray8ToWasm0(r1cs_bytes, wasm.__wbindgen_export);
            const len1 = WASM_VECTOR_LEN;
            wasm.witnesscalculator_new(retptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            this.__wbg_ptr = r0 >>> 0;
            WitnessCalculatorFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    ...
    get num_public_inputs() {
        const ret = wasm.witnesscalculator_num_public_inputs(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get witness_size() {
        const ret = wasm.witnesscalculator_witness_size(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) WitnessCalculator.prototype[Symbol.dispose] = WitnessCalculator.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_bind_29ba380591735d8c: function(arg0, arg1, arg2) {
        ...
        __wbg_constructor_ad6c0ed428f55d34: function(arg0) {
        ...
        __wbg_exports_794a42000dacd046: function(arg0) {
        ...
        __wbg_getPrototypeOf_2653517f1dc884d5: function() { return handleError(function (arg0) {
        ...
        __wbg_imports_8333d40ab24779ad: function(arg0) {
        ...
        __wbg_instanceof_Function_2a29eec978bb3b11: function(arg0) {
            let result;
            try {
        ...
        __wbg_instanceof_Table_127f216e592f4159: function(arg0) {
            let result;
            try {
        ...
        __wbg_instanceof_Tag_f1d6b24a98b95210: function(arg0) {
            let result;
            try {
        ...
        __wbg_new_b061c0550d9f3281: function() { return handleError(function (arg0) {
...
const WitnessCalculatorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_witnesscalculator_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('witness_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
